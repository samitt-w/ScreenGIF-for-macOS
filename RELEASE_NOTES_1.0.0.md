...
First public release of ScreenGIF, a lightweight macOS menu bar app for recording part of your screen and exporting it as an animated GIF.
...
- First public release of ScreenGIF
...
- Quality controls for FPS, colours, dithering, and resolution
- Original / After workflow for comparing the source and built GIF
- Export flow with recent GIF history
- `ffmpeg_setup.command` helper for installing ffmpeg more easily
